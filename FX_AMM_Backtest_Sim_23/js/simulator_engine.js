const SimulatorEngine = {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            models.forEach((model, idx) => {
                ...
                if (amountOut > 0) {
                    ...
                    let targetPrice = targetOracle;
                    slippage = ((targetPrice - executionPrice) / targetPrice) * 100;
                }
                ...
                if (amountOut > 0) {
                    ...
                    stat.slippageHistory.push({
                        t: stepData.t,
                        slippage: slippage,
                        direction: direction ? 'BuyKRW' : 'SellKRW'
                    });
                } else {
                ...
                const reserveRatio = state.resUSD > 0 ? state.resKRW / state.resUSD : 0;
                ...
                stat.history.push({
                    ...
                    reserveRatio: Number(reserveRatio) || 0,
                    hodlValue: hodlValue,
                    ilPct: ilPct,
                    feeUSD: stat.feesUSD,
    ...
    runArbitrage: function(model, oraclePrice, feeTier) {
        ...
        for (let k = 0; k < maxLoops; k++) {
            ...
            let amountOut = model.swap(amountIn, isBuyKRW, true);
